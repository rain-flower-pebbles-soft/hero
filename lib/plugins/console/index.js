...
var schemaOptions = {
  alias: 'x',
  desc: 'Transform xml schema to json schema',
  init: true
};

console.register('schema', 'Generate json schema from xml schema', schemaOptions, require('./schema'));


var sequelizeOptions = {
  alias: 'orm',
  desc: 'Generate sequelize models form json scheme',
  init: true
};

console.register('sequelize', 'Transfrom the json schema to sequelize models', sequelizeOptions, require('./sequelize'));

var CRUDByModuleOption = {
  alias : 'crud',
  desc: 'create crud by model',
  init: true
};

console.register('crudbymodel', 'create crud by sequelize model', CRUDByModuleOption, require('./crudbymodel'));
...
console.register('swagger', 'create swagger api', swagger, require('./swagger'));
